...
// Intentionally vulnerable URL fetcher for the security scan demo.
app.get('/fetch-demo', function (req, res) {
  var target = req.query.url || 'http://127.0.0.1:3001/';

  http.get(target, function (upstream) {
...
// Intentionally vulnerable login route for the security scan demo.
app.get('/login-demo', function (req, res) {
